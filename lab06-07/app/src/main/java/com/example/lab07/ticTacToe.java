...
public class ticTacToe extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //in ticTacToeRowBoard adapter constructor we put History of Moves as initialization
        ...
        gv.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> arg0, View arg1, int arg2, long arg3) {
                ...
                if(status!= ticTacToe.WAIT)
                {
                    ...
                    //Getting game (ticTacToeRowBoard Adapter)
                    GridView gv = (GridView) findViewById(R.id.gridView);
                    ticTacToeBoard game = (ticTacToeBoard)gv.getAdapter();
                    //Make Move

                    if(game.add(arg2+1)!=null)
                        gv.setAdapter(game);
                    else
                    ...
                    PendingIntent pendingResult = createPendingResult(HttpService.TICTACTOE, new Intent(),0);
                    ...
                    //Set data - parameters
                    intencja.putExtra(HttpService.PARAMS, "moves=" + moves + (arg2+1));
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        if (requestCode == HttpService.TICTACTOE) {
            try {
    ...
    private void hints(int status){
        TextView hint = (TextView)findViewById(R.id.ticTacToeHint);
        switch(status){
